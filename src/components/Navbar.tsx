...
export function Navbar({ progress, onHomeClick }: NavbarProps) {
  return (
    <>
      {/* Progress bar */}
      ...
      <nav className="fixed top-1 left-0 w-full px-8 py-4 flex justify-between items-center z-50 bg-military-950/90 backdrop-blur-sm border-b border-military-700/30">
        <button
          onClick={onHomeClick}
          className="military-font text-xl tracking-widest text-military-500 hover:text-military-400 transition-colors cursor-pointer"
        >
          ⬢ TANK
        </button>
